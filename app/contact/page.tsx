      ...
      <section className="border-b border-border">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 sm:py-28 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20 lg:px-8 lg:py-28">
          <div className="flex flex-col gap-10">
            <div><p className="font-mono text-xs uppercase tracking-[0.18em] text-primary">Contact</p><h1 className="mt-6 text-balance text-5xl font-semibold leading-none tracking-[-0.045em] sm:text-7xl">Let’s make the next decision clearer.</h1><p className="mt-8 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground">Share what you are navigating—an AI strategy, cloud transformation, architecture decision, or leadership challenge. A little context is enough to begin.</p></div>
